...
export const alphaValue: RegExp = /((?:100\.[0]+|100|(?:[0-9]|[1-9][0-9])(?:\.\d+)?|\.\d+)%|[0]?\.\d+|1\.[0]+|1|0)/;
export const percent: RegExp = /((?:100\.[0]+|100|(?:[0-9]|[1-9][0-9])(?:\.\d+)?|\.\d+)%)/;
export const comma: RegExp = /\s*,\s*/;
export const space: RegExp = /\s*/;
export const alpha: RegExp = new RegExp(`(?:\\s*,\\s*${alphaValue.source})`);
export const alphaCss4: RegExp = new RegExp(`(?:\\s*\\/\\s*${alphaValue.source})`);
